...
archive = '/home/mher/ism/runs/oneSided/uniformSweep2-z-0.5/'
...
#----------------------------------------------------------------------------
z = 1.0
archive = '/home/mher/ism/runs/oneSided/uniformSweep2-z-1.0-no-mech/'
for (specStr, transitions) in species:
    for transition in transitions:
        print specStr, transition
        runGrid(archive, z, -30.0, specStr, transition )
archive = '/home/mher/ism/runs/oneSided/uniformSweep2-highRes-z-1.0/'
for gm in [-24.0, -23.0, -22.0, -21.0, -20.0, -19.0, -18.0, -17.0, -16.0]:
    for (specStr, transitions) in species:
        for transition in transitions:
            print specStr, transition
