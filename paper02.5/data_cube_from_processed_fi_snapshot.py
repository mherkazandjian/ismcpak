...
fig_save_path = home +  '/ism/docs/paper02.5/src/figs/channel_maps/plot.eps'
...
pylab.colorbar(im, ax=ax_map, cax=cbar_ax_map, orientation='horizontal', 
                   ticks=cbar_ticks)
cbar_ax_map.set_xticklabels(xticks_strs)
...
###########################################################################################################
fig = fi_utils.plot_cube_sections(data_cube, params)
