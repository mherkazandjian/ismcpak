...
axs[0].set_xlabel(r'R(kpc)', size=15)
axs[0].set_ylabel(r'<$\Gamma_{\rm mech} / n $>', size=15)

axs[1].set_xlabel(r'<$\Gamma_m / n $>', size=15)
axs[1].set_ylabel(r'$T_{ex}$ (K)', size=15)

axs[2].set_xlabel(r'R(kpc)', size=15)
axs[2].set_ylabel(r'$T_{ex}$ (K)', size=15)
