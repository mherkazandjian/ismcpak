...
fig, axs = pylab.subplots(1, 4, sharex=True, sharey=True, figsize=(7, 3.1),
                          subplot_kw = {'xlim':[-8, 8],  #keywords passed to figure.add_subplot()
                                        'ylim':[-8, 8],
                                        'aspect':'auto',
                                        'adjustable':'datalim',
                                        'autoscale_on' : False,   # enforces the set limits (ranges) of the subplot axes
                                        'xticks': pylab.linspace(-5, 5, 3),
                                        'yticks': pylab.linspace(-5, 5, 3),
                                        }
                          )
...
cbar4.set_yticks([])
cbar4.set_xlim(0, 30)
cbar4_ticks = numpy.linspace(5, 30, 6)
...
fig.savefig('/home/mher/ism/docs/paper02.5/src/figs/n_g_gmech_av_maps/disk.eps')
