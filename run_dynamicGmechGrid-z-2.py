...
outputDir     = home + '/ism/runs/oneSided/dynamicMeshTest1-z-2/'

# path of the database from which the surface mech heating rates will be extracted
databasePath  = home + '/ism/runs/oneSided/surfaceSlabSweep-z-2-no-mech/'
...
t0 = time()
arxv = meshArxv( metallicity = metallicity, dirPath = databasePath)
...
z = [1e-10, 0.0001, 0.001, 0.01, 0.05, 0.1, 0.25, 0.50, 0.75, 1.0]
