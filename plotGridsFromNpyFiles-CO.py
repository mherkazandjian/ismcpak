...
filesNfo = (
           # row 1 (from top)
            (  
             (baseDir, specStr, '1', '0', metallicity, gMech), # [0][0]
             (baseDir, specStr, '2', '1', metallicity, gMech), # [0][1]
             (baseDir, specStr, '3', '2', metallicity, gMech), # [0][2]
            ),
           # row 2 (from top)
            (  
             (baseDir, specStr, '6' , '5' , metallicity, gMech), # [1][0]
             (baseDir, specStr, '10', '9' , metallicity, gMech), # [1][2]
             (baseDir, specStr, '16', '15', metallicity, gMech), # [1][3]
            )
           )
