...
#                      'f_mean_em_<q>fluxKkms</q>_13CO<template>' : 15,
                      ...
                      'f_mean_em_<q>fluxKkms</q>_HCN<template>' : 7,
                      'f_mean_em_<q>fluxcgs</q>_HCN<template>' : 7,

                      'f_mean_em_<q>fluxKkms</q>_HNC<template>' : 7,
                      'f_mean_em_<q>fluxcgs</q>_HNC<template>' : 7,

                      'f_mean_em_<q>fluxKkms</q>_HCO+<template>' : 7,
                      'f_mean_em_<q>fluxcgs</q>_HCO+<template>' : 7,

                      'f_mean_em_<q>fluxKkms</q>_CS<template>' : 7,
                      'f_mean_em_<q>fluxcgs</q>_CS<template>' : 7,

                      'f_mean_em_<q>fluxKkms</q>_CN<template>' : 7,
                      'f_mean_em_<q>fluxcgs</q>_CN<template>' : 7,

                      'f_mean_em_<q>fluxKkms</q>_SiO<template>' : 7,
                      'f_mean_em_<q>fluxcgs</q>_SiO<template>' : 7,
...
#                      'f_mean_em_<q>fluxKkms</q>_13CO<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxKkms</q>_CO<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_CO<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},

                      'f_mean_em_<q>fluxKkms</q>_13CO<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_13CO<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},

                      'f_mean_em_<q>fluxKkms</q>_HCN<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_HCN<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},

                      'f_mean_em_<q>fluxKkms</q>_HNC<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_HNC<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},

                      'f_mean_em_<q>fluxKkms</q>_HCO+<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_HCO+<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},

                      'f_mean_em_<q>fluxKkms</q>_SiO<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_SiO<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},

                      'f_mean_em_<q>fluxKkms</q>_CS<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_CS<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},

                      'f_mean_em_<q>fluxKkms</q>_CN<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
                      'f_mean_em_<q>fluxcgs</q>_CN<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
#                      'f_mean_em_<q>fluxKkms</q>_HCN<template>'  : {'pos': [2,0], 'title': r'$f(L_{CO(1-0})$'     , 'v_rng': [-10.0, -4.0] , 'log10': True},
...
#                      'f_mean_em_<q>tau</q>_13CO<template>'       : {'pos': [3,3], 'title': r'$f(tau_{CO(1-0})$'   , 'v_rng': [0.0, 1000.0] , 'log10': False},
          ...
          'save_info'    : True,
          'save_species' : ['CO','13CO','HCN','HNC','HCO+','SiO','CN','CS'],
          }
