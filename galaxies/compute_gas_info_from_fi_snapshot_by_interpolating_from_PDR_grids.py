...
params = {#'rundir': home + '/ism/runs/galaxies/coset2run4/coset-2-std', # the path of the dir containing the simulation
          ...
          'emission': {
#                      'f_mean_em_<q>fluxcgs</q>_CO<template>'  : 1,
#                      'f_mean_em_<q>fluxKkms</q>_CO<template>' : 1,
#                      'f_mean_em_<q>Tex</q>_CO<template>'      : 1,
#                      'f_mean_em_<q>tau</q>_CO<template>'      : 1,
##                      
#                      'f_mean_em_<q>fluxcgs</q>_13CO<template>' : 1,
#                      'f_mean_em_<q>fluxKkms</q>_13CO<template>': 1,
#                      'f_mean_em_<q>Tex</q>_13CO<template>'     : 1,
#                      'f_mean_em_<q>tau</q>_13CO<template>'     : 1,
                      },
