...
pdr.set_species_fName              (dataDir + 'species.inp');
pdr.set_underUbundant_fName        (dataDir + 'underabundant.inp');
pdr.set_rate99_fName               (dataDir + 'rate99.inp');
pdr.set_selfSheilding_CO_fName     (dataDir + 'self_shielding_CO.inp');
pdr.set_rotationalCooling_baseName (dataDir + 'rotationalcooling/rotcool');
pdr.set_vibrationalCooling_baseName(dataDir + 'vibrationalcooling/vibcool');
pdr.set_database_fName             (dataDir + 'z-1.0.dat');
